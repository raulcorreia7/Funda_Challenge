...
namespace FundaAPIClient.Tests
{
    ...
    public class FundaAPIClientLocalTests
    {

        public FundaAPIClientLocalTests(ITestOutputHelper output)
        {
            LoggerSetup.SetupLoggerForTest(output, nameof(FundaAPIClientLocalTests));
        }
        ...
        /// </summary>
        [Fact]
        public void FundaAPIClientLocalGetTop10()
        {
            #region Scenario Setup
            IFundaAPIClient fundaAPIClient = new FundaAPIClient();

            fundaAPIClient.AddCrawler(new CrawlerLocal());
        ...
        /// </summary>
        [Fact]
        public void FundaAPIClientLocalGetTop10WithTuin()
        {
            #region Scenario Setup
            IFundaAPIClient fundaAPIClient = new FundaAPIClient();
